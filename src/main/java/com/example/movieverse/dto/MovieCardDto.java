...
public class MovieCardDto {
    ...
    public MovieCardDto(String title, String age, LocalDate year, String director, String distributionPeriod, String moviegoerRating, String criticsRating, String genre, String duration, String production, String studio, String screenplay, String starring, String description, String trailerIframeLink) {
        this.title = title;
        this.age = age;
        this.year = year;
