...
public class MovieCard {
    ...
    public MovieCard(String title, String age, int year, String director, String moviegoerRating, String criticsRating, String genre, String duration, String production, String studio, String screenplay, String starring, String description, String trailerIframeLink) {
        this.title = title;
        this.age = age;
        this.year = year;
